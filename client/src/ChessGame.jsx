...
//   const [moveHistory, setMoveHistory] = useState([]); // Store actual moves
//   const [gameStates, setGameStates] = useState([new Chess().fen()]); // Store FEN positions
...
//   const [activeTimer, setActiveTimer] = useState(null); // 'w' or 'b'
...
//         newMoveHistory.push(moveResult.san); // Store the move in standard algebraic notation
...
//       } else if (g.isDraw()) return "Draw!";
//       else if (g.isStalemate()) return "Stalemate!";
//       else if (g.isInsufficientMaterial()) return "Draw: Insufficient Material";
...
//       if (status) {
//         setGameOver(status);
//         setActiveTimer(null); // Stop timer
//       } else {
//         setActiveTimer(g.turn()); // Switch to the next player
//       }
//       return moveResult;
//     });
//   };
...
//     // moveIndex is the index in the gameStates array
//     // For move history display, we want to jump to the position after that move
//     const targetIndex = moveIndex + 1; // +1 because gameStates[0] is initial position
...
//     const file = square.charCodeAt(0) - "a".charCodeAt(0); // 'a' to 0
//     const rank = 8 - parseInt(square[1], 10); // rank 8 to 0
//     return {
//       left: `${file * 62.5}px`,
//       top: `${rank * 62.5}px`,
//     };
...
//     const rank = parseInt(square[1], 10); // rank as number
...
//             }}
//           >
//             <div style={{ color: activeTimer === "w" ? "#000" : "#888" }}>
//               ♔ White: {formatTime(whiteTime)}
//             </div>
//             <div style={{ color: activeTimer === "b" ? "#000" : "#888" }}>
